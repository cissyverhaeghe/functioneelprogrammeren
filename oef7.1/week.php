...
<div class="container">
    ...
    //ik heb hiermee zitten spelen om dit in de loop te krijgen, maar het is mij niet gelukt

    //$maandag = strtotime("Monday this week");
    //$maandagdatum = date("Y/m/d", $maandag);
    //print $maandagdatum;
    //$mydate = new DateTime($maandagdatum);
    //$mydate->modify('+1 day');
